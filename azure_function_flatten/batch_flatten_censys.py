#!/usr/bin/env python3
"""Batch flatten existing censys parquet files and upload to flattened/ prefix."""
import os
import sys
import tempfile
...
import pandas as pd
from azure_function_flatten.flatten_blob_trigger_censys.__init__ import flatten_df, sanitize_for_parquet
